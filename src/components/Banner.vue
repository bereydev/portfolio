        ...
        <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
          <div class="w-full lg:max-w-md">
            <h2 class="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">
              Bereyziat Development is a fast growing group of talented indivuduals here to provide the interaction with the tool of the web.
            </h2>
            <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
              If you feel like beeing part of this adventure as adventure do not hesitate to submit your CV at bereyziat.recruitment@gmail.com
            </p>
            <ul>
