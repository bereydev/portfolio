    ...
    <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
      <div class="relative flex flex-col md:flex-row">
        ...
        >
          <span class="mx-auto text-xl font-black leading-none text-gray-900 select-none">
            <img src="/bereyziat_logo_full.svg" height="60" width="200" alt="Bereyziat Development Logo">
          </span>
        </a>
      ...
      <div class="inline-flex items-center ml-5 space-x-6  lg:justify-end">
        ...
        <a
          ...
          class="inline-flex items-center justify-center px-4 py-2 hidden md:block text-base font-medium leading-6 text-white whitespace-no-wrap bg-purple-500 border border-transparent rounded-full shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
        >
          {{ t('button.contact') }}
        </a>
      </div>
